...
namespace WebBanSua.Areas.Admin.Controllers
{
    ...
    public class AdminRolesController : Controller
    {
        ...
        public AdminRolesController(DemoWebSuaContext context, INotyfService notyfService)
        {
            _context = context;
        ...
        public IActionResult Index(int? page)
        {
            ...
            var pageSize = 10;
            var lsCategories = _context.Roles
                .AsNoTracking()
                .OrderBy(x => x.RoleId);
            PagedList<Role> models = new PagedList<Role>(lsCategories, pageNumber, pageSize);
        ...
        public async Task<IActionResult> Create([Bind("RoleId,RoleName,Des")] Role role)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RoleId,RoleName,Des")] Role role)
        {
            if (id != role.RoleId)
            {
                return NotFound();
